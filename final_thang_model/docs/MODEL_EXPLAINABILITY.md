...
| Legacy v1-v4 blend (Pipeline C) | 4 | final_model v1, v2, v3, v4 |
...
│  └──────────────┘ └──────────────┘ └──────────────────────┘     │
│                                                                 │
│  → Tất cả 16 models đều dùng CÙNG LOẠI features này            │
│  → Chỉ khác ở cách combine (recursive vs direct, weights)       │
│                                                                 │
├─────────────────────────────────────────────────────────────────┤
...
│  │                                                          │    │
│  │  M5_blend = weighted avg(v1, v2, v3, v4)                │    │
