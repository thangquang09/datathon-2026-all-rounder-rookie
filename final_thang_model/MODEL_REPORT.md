...
```
M5 blend = 50% v1 + 30% v2 + 5% v3 + 15% v4
```
...
| **Holidays** | `docs/vietnam_holiday_calendar_2012_2024.csv` | Lễ Việt Nam, retail events |
...
| 30/4 – 1/5 | `vn_days_to_liberation`, `vn_days_to_may1` | Kỳ nghỉ dài, demand shift |
