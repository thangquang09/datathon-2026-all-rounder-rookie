"""Compute SHAP values for trained LightGBM revenue forecasting models.

Run after `src.models.lightgbm_revenue_forecast` has written the model files
under outputs/models/.
Produces:
...
from src.models.lightgbm_revenue_forecast import (
    MODELS,
