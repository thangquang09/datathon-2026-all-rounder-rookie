...
(`components.final_model_v4`) because it contains the most complete engineered feature
...
from src.models.sales_forecasting.pipeline.forecast_pipeline import (
    FORECAST_END,
    FORECAST_START,
    TARGETS,
    export_submission,
...
def main() -> None:
    ...
    summary = {
        ...
        "levels": levels,
        "leakage_policy": [
            "components.final_model_v4 builds features from train CSVs only",
