...
def build_v1_raw(dates: pd.DatetimeIndex) -> pd.DataFrame:
    from src.models.sales_forecasting.components import final_model as fm
...
def build_v2_raw(dates: pd.DatetimeIndex) -> pd.DataFrame:
    from src.models.sales_forecasting.components.final_model_v2 import fit_and_forecast
...
def build_v3_raw(dates: pd.DatetimeIndex) -> pd.DataFrame:
    from src.models.sales_forecasting.components.final_model_v3 import (
        build_frame_v3,
        feature_cols,
        train_seed,
        train_full,
...
def load_or_build_v4_raw(dates: pd.DatetimeIndex) -> pd.DataFrame:
    ...
    from src.models.sales_forecasting.components.final_model_v4 import fit_and_forecast
