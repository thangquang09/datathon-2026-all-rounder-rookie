...
Outputs:
- outputs/final/model_submission.csv          (final submission file)
- outputs/final/metrics.json                  (TS-CV + holdout metrics)
- outputs/final/feature_importance_*.csv      (LGBM gain ranking)
- outputs/final/shap_*.png                    (written separately)
"""
