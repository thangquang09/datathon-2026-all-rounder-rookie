"""Daily operational feature engineering for revenue forecasting.
...
Features cover category mix, payment behavior, traffic, returns, reviews,
shipments, inventory, and customer/geography signals. Vietnamese calendar
features live in `src.utils.calendar_vn`.
"""
