...
This file is generated by `src/utils/calendar_vn.py::build_vn_event_calendar()` from
...
File audited: `src/utils/calendar_vn.py`.
...
- Added solar-to-lunar conversion in `src/utils/calendar_vn.py`.
