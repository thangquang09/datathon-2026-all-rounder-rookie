...
![Profit Lorenz Curve](assets/customer_segmentation_ltv/01_profit_lorenz_curve.png)
...
![Segment Profit Share](assets/customer_segmentation_ltv/02_segment_profit_share.png)
...
![Segment Radar](assets/customer_segmentation_ltv/03_segment_radar.png)
...
![Segment Health Heatmap](assets/customer_segmentation_ltv/09_segment_health_heatmap.png)
...
![Promotion Margin by Segment](assets/customer_segmentation_ltv/04_promo_margin_by_segment.png)
...
![UX Friction by Segment](assets/customer_segmentation_ltv/05_ux_friction_by_segment.png)
...
![Cohort Retention Heatmap](assets/customer_segmentation_ltv/06_cohort_retention_heatmap.png)
...
![Quarterly Retention Curves](assets/customer_segmentation_ltv/12_quarterly_retention_curves.png)
...
![Early Loyalty Coefficients](assets/customer_segmentation_ltv/07_loyalty_propensity_coefficients.png)
...
![XGBoost Loyalty Feature Importance](assets/customer_segmentation_ltv/10_xgboost_loyalty_feature_importance.png)

![XGBoost Loyalty Group Importance](assets/customer_segmentation_ltv/11_xgboost_loyalty_group_importance.png)
