...
> Hình cần bổ sung: Top problematic products (`docs/images/problematic_products_top15.png`).
...
> Hình cần bổ sung: Return reasons overall (`docs/images/return_reason_overall.png`).

> Hình cần bổ sung: Return reasons all vs problematic (`docs/images/return_reason_all_vs_problematic.png`).
...
> Hình cần bổ sung: Unsold distribution (`docs/images/unsold_distribution.png`).
...
> Hình cần bổ sung: Top co-purchased pairs (`docs/images/copurchase_top15_by_orders.png`).

> Hình cần bổ sung: Deduped Apriori top pairs by volume (`docs/images/apriori_dedup_top15_volume.png`).

> Hình cần bổ sung: Lift vs co-orders (`docs/images/copurchase_lift_scatter.png`).

> Hình cần bổ sung: Deduped Apriori lift vs volume (`docs/images/apriori_dedup_lift_vs_volume.png`).
...
> Hình cần bổ sung: No-repeat 90d by event (`docs/images/churn_no_repeat_90d_by_event.png`).

> Hình cần bổ sung: Churn 180d by exposure (`docs/images/churn_180d_by_exposure.png`).
...
> Hình cần bổ sung: Shipping stats comparison (`docs/images/shipping_stats_comparison.png`).

> Hình cần bổ sung: Shipping per SKU risky (`docs/images/shipping_per_sku_risky.png`).

> Hình cần bổ sung: Shipping CDF returned only (`docs/images/shipping_cdf_returned_only.png`).

> Hình cần bổ sung: Shipping mean by return reason (`docs/images/shipping_mean_by_return_reason.png`).
...
> Hình cần bổ sung: Unsold inventory coverage (`docs/images/unsold_inventory_coverage.png`).

> Hình cần bổ sung: Unsold inventory months distribution (`docs/images/unsold_inventory_months_distribution.png`).
...
- `data/processed/eda_insight_report/products_returned_and_low_rated.csv`
- `data/processed/eda_insight_report/products_not_purchased.csv`
- `data/processed/eda_insight_report/copurchase_pairs_top_by_orders.csv`
- `data/processed/eda_insight_report/copurchase_pairs_top_by_lift.csv`
- `data/processed/eda_insight_report/churn_linkage_summary.csv`
- `data/processed/eda_insight_report/return_reason_overall.csv`
- `data/processed/eda_insight_report/return_reason_problematic_products.csv`
- `data/processed/eda_insight_report/return_reason_comparison_problematic_vs_all.csv`
- `data/processed/eda_insight_report/apriori_frequent_itemsets.csv`
- `data/processed/eda_insight_report/apriori_rules.csv`
- `data/processed/eda_insight_report/apriori_pair_rules_deduped.csv`
- `data/processed/eda_insight_report/apriori_pair_rules_deduped_top20.csv`
- `data/processed/eda_insight_report/apriori_rules_top20_lift.csv`
- `data/processed/eda_insight_report/apriori_rules_top20_support.csv`
- `data/processed/eda_insight_report/apriori_rules_top20_confidence.csv`
- `data/processed/eda_insight_report/inventory_unsold_linkage_by_product.csv`
- `data/processed/eda_insight_report/inventory_ending_snapshot_with_unsold_flag.csv`
- `data/processed/eda_insight_report/inventory_unsold_linkage_summary.csv`
- `data/processed/eda_insight_report/inventory_unsold_ending_summary.csv`
- `docs/images/problematic_products_top15.png`
- `docs/images/unsold_distribution.png`
- `docs/images/copurchase_top15_by_orders.png`
- `docs/images/copurchase_lift_scatter.png`
- `docs/images/churn_no_repeat_90d_by_event.png`
- `docs/images/churn_180d_by_exposure.png`
- `docs/images/return_reason_overall.png`
- `docs/images/return_reason_all_vs_problematic.png`
- `docs/images/apriori_dedup_top15_volume.png`
- `docs/images/apriori_dedup_lift_vs_volume.png`
- `docs/images/unsold_inventory_coverage.png`
- `docs/images/unsold_inventory_months_distribution.png`
- `data/processed/eda_insight_report/shipping_fulfillment_stats.csv`
- `data/processed/eda_insight_report/shipping_transit_stats.csv`
- `data/processed/eda_insight_report/shipping_per_sku_risky.csv`
- `data/processed/eda_insight_report/shipping_returned_orders_stats.csv`
- `docs/images/shipping_stats_comparison.png`
- `docs/images/shipping_per_sku_risky.png`
- `docs/images/shipping_cdf_risky_vs_nonrisky.png`
- `docs/images/shipping_cdf_returned_only.png`
- `docs/images/shipping_mean_by_return_reason.png`
