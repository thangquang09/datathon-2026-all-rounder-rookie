# Pipeline Documentation — `sales_forecast_submission`
...
Built from `legacy_components/calendar_vn.py` using deterministic rules from the Gregorian
...
**File**: `pipeline/forecast_pipeline.py`
...
**File**: `pipeline/explainable_forecast_factory.py`
...
**Files**: `legacy_components/final_model.py`, `legacy_components/final_model_v2.py`, `legacy_components/final_model_v3.py`, `legacy_components/final_model_v4.py`
...
**File**: `pipeline/build_direct_lgb_candidates.py`
...
│
├── legacy_components/                                    ← Core modules
│   ├── __init__.py
...
│
└── artifacts/                              ← Generated metrics, candidates, saved models, figures
