...
**File:** `sales_forecast_submission/submission.csv`
...
**Candidate file:** `artifacts/final_candidates/submission_m5_lgb_direct_blend_80_20.csv`
...
Tất cả script nằm trong `sales_forecast_submission/`, chỉ đọc dữ liệu từ `../data/`.
