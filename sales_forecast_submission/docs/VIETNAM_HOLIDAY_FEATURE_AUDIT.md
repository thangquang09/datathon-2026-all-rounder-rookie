...
This file is generated by `legacy_components/calendar_vn.py::build_vn_event_calendar()` from
...
File audited: `legacy_components/calendar_vn.py`.
...
- Added solar-to-lunar conversion in `legacy_components/calendar_vn.py`.
