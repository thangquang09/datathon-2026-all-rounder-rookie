...
(`legacy_components.final_model_v4`) because it contains the most complete engineered feature
...
def main() -> None:
    ...
    summary = {
        ...
        "levels": levels,
        "leakage_policy": [
            "legacy_components.final_model_v4 builds features from train CSVs only",
